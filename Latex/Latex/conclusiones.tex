...
\begin{itemize}
    ...
    En particular, cabe destacar tal y cómo se indicó en la \nameref{sec:seleccion}, las \emph{Bulletproofs}, que son algoritmos mucho más potentes, pero tienen el gran inconveniente de usar número demasiado grandes que, aunque no son un problema para un ordenador, dificulta en parte entender su funcionamiento.
