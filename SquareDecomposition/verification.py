...
if __name__ == '__main__':
    ...
    # ns = [31, 607, 1291, 2053, 2803, 3637, 4481, 5351, 6203, 7057, 7963, 8867, 9769, 10709, 11699, 12589, 13537,
    # 14543, 15427, 16417, 17393, 18329, 19423, 20357, 21379, 22303, 23297, 24247, 25357, 26371, 27409, 28447, 29401,
    # 30517]
